export const STRING_WITH_INVALID_FORMAT = 'La cadena no contiene el formato correcto';
export const INVALID_MIN = 'El minimo no puede ser mayor al maximo';
export const REQUIRES_PARAMS = 'Los parametros son requeridos';
